...
@testset ExtendedTestSet "FunctionSpaces - H1Field" begin
  mesh = UnstructuredMesh("mechanics/mechanics.g")
  @show fspace = FunctionSpace(mesh, H1Field, Lagrange)
end

@testset ExtendedTestSet "FunctionSpaces - L2ElementField" begin
  mesh = UnstructuredMesh("mechanics/mechanics.g")
  @show fspace = FunctionSpace(mesh, L2ElementField, Lagrange)
end

@testset ExtendedTestSet "FunctionSpaces - L2QuadratureField" begin
  mesh = UnstructuredMesh("mechanics/mechanics.g")
